...
{
    public class LykkeHedgeTradeSubscriber : IDisposable
    {
        ...
        public LykkeHedgeTradeSubscriber(
        ...
        private async Task ProcessMessageAsync(ExecutionEvent message)
        {
            ...
            if (orders.Any())
            {
                try
                {
                    ...
                    await _internalHedgeTradeHandler.HandleInternalTradesAsync(internalTrades);
                }
