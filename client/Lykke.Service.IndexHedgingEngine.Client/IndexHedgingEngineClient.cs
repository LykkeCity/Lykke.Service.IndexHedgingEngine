...
namespace Lykke.Service.IndexHedgingEngine.Client
{
    ...
    public class IndexHedgingEngineClient : IIndexHedgingEngineClient
    {
        ...
        public IndexHedgingEngineClient(IHttpClientGenerator httpClientGenerator)
        {
            ...
            CrossIndex = httpClientGenerator.Generate<ICrossIndexApi>();
            ...
            Simulation = httpClientGenerator.Generate<ISimulationApi>();
        ...
        /// <inheritdoc/>
        public ICrossIndexApi CrossIndex { get; }
        ...
        /// <inheritdoc/>
        public ISimulationApi Simulation { get; }
